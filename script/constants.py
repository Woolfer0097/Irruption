...
dialog_texts = [[{"hero": "Привет, кто ты?"},
                ...
                [{"hero": "Привет123, кто ты?"},
                 {"bars": "Привет213, я Ирбис и это моя территория!"},
                 {"hero": "Ох, 321извини, я не хочу тревожить тебя..."},
                 {"bars": "231Ну что ж... Просто так я тебя не отпущу!"},
                 {"bars": "Знаешь ли, в этих краях очень скучно"},
                 {"bars": "Придётся тебе поиграть со мной!"}]
                ]
